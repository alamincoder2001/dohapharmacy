	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10">
				...
				<?php endif; ?>
				<?php if (array_search("genetic", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<div class="col-md-2 col-xs-6 ">
						<div class="col-md-12 section20">
							<a href="<?php echo base_url(); ?>genetic">
								<div class="logo">
									<i class="menu-icon fa fa-sitemap"></i>
								</div>
								<div class="textModule">
	...
	<div class="row">
		<div class="col-md-12 col-xs-12">
			...
			<div class="col-md-10">
				...
				<?php endif; ?>
				<?php if (array_search("top_low_sold", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
					<div class="col-md-2 col-xs-6 ">
						<div class="col-md-12 section20">
							<a href="<?php echo base_url(); ?>top_low_sold">
								<div class="logo">
									<i class="menu-icon fa fa-file"></i>
								</div>
								<div class="textModule" style="margin-top: 2px; line-height: 14px;">
									Top & Low Sold Report
								</div>
							</a>
						</div>
