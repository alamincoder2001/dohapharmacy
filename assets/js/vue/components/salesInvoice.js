        ...
        async print(){
            ...
            if (this.currentBranch.print_type == '3') {
                    ...
                    <html>
                        ...
                        <body>
                            <div style="text-align:center;">
                                <img src="/uploads/brunch/${this.currentBranch.Branch_Logo_thum}" alt="Logo" style="height:60px;margin:0px;" /><br>
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="row">
                            <div class="col-xs-2"><img src="/uploads/brunch/${this.currentBranch.Branch_Logo_thum}" alt="Logo" style="height:60px;" /></div>
